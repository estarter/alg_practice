 ...
 */
public class FindMaxWeightTimeBasedTest {
    @Test
    public void testSimple() throws Exception {
        ...
        assertEquals(18, FindMaxWeightTimeBased.findMaxWeight(Intervals));
    }
    @Test
    public void testAnotherExample() throws Exception {
        ...
        assertEquals(52, FindMaxWeightTimeBased.findMaxWeight(Intervals));
    }
    @Test
    ...
    public void testEmtpy() throws Exception {
        ...
        assertEquals(0, FindMaxWeightTimeBased.findMaxWeight(Intervals));
    }
    @Test
    public void testOne() throws Exception {
        ...
        assertEquals(10, FindMaxWeightTimeBased.findMaxWeight(Intervals));
    }
    @Test
    public void testSameLength() throws Exception {
        ...
        assertEquals(11, FindMaxWeightTimeBased.findMaxWeight(Intervals));
    }
    @Test
